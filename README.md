...
| Demo 可用（本地 Ollama） | ✅ 是 |
| 下一個任務 | TASK-258 Owner Voice Gate Research（TASK-257 DONE - WINDOWS PET WINDOW CLICK/SHOW SMOKE PASS：Show Pet 冪等，avatar click 不隱藏，Hide 只透過 context menu；TASK-256/256b DONE）|
