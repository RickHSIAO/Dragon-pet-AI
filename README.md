...
| [docs/TTS_ARCHITECTURE.md](docs/TTS_ARCHITECTURE.md) | TASK-TTS-001 provider-neutral TTS architecture：text normalization、TTS queue、provider adapter、Conversation Mode and Pet Window integration、diagnostics、phased plan |
| [docs/TTS_PROVIDER_RESEARCH.md](docs/TTS_PROVIDER_RESEARCH.md) | TASK-TTS-001 provider research：local/offline candidates、mock provider path、evaluation criteria、voice data rules、future singing boundary |
...
| `docs/TTS_ARCHITECTURE.md` | TASK-TTS-001 provider-neutral local TTS architecture, text normalization, queue, Conversation Mode, Pet speaking state, diagnostics, and phased implementation plan |
| `docs/TTS_PROVIDER_RESEARCH.md` | TASK-TTS-001 local TTS provider research boundaries, candidate categories, evaluation criteria, voice data rules, and future provider path |
