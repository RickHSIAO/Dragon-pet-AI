...
| Demo 可用（本地 Ollama） | ✅ 是 |
| 下一個任務 | Continue pending TASK-CONV-001 and TASK-AUDIO-001 Windows runtime smoke. TASK-CONV-004 and TASK-PERSONA-001 are closed; keep debug fallback repair enabled unless a future runtime tone task deliberately replaces it. |
