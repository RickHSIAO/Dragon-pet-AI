...
| TTS provider probe | ✅ TASK-TTS-004C2 DONE - EDGE-TTS AUDIO OUTPUT SUCCESS / TEMP CHINESE PROVIDER ONLY；edge-tts understandable Chinese but weak Christina/anime fit；no runtime wiring/playback/default-provider change |
