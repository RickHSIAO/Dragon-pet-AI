...
| [docs/TTS_ARCHITECTURE.md](docs/TTS_ARCHITECTURE.md) | TASK-TTS-001/TASK-TTS-003 provider-neutral TTS architecture：text normalization、disabled queue diagnostics、mock provider skeleton、local provider probe phase、Conversation Mode and Pet Window integration、diagnostics、phased plan |
| [docs/TTS_PROVIDER_RESEARCH.md](docs/TTS_PROVIDER_RESEARCH.md) | TASK-TTS-001/TASK-TTS-003 provider research：local/offline candidates、implemented mock provider boundary、candidate probe table、evaluation criteria、voice data rules、future singing boundary |
...
| `docs/TTS_ARCHITECTURE.md` | TASK-TTS-001/TASK-TTS-003 provider-neutral local TTS architecture, mock provider skeleton, disabled queue diagnostics, local provider probe phase, text normalization, Conversation Mode, Pet speaking state, and phased implementation plan |
| `docs/TTS_PROVIDER_RESEARCH.md` | TASK-TTS-001/TASK-TTS-003 local TTS provider research boundaries, candidate categories, implemented mock provider non-quality boundary, probe status table, evaluation criteria, voice data rules, and future provider path |
