...
| TTS provider probe | ✅ TASK-TTS-004D3 DONE - CHARACTER VOICE LAB PLAN READY / NO LAB INSTALL PERFORMED；isolated lab required before GPT-SoVITS / Style-Bert-VITS2 install；runtime disabled/mock-only |
