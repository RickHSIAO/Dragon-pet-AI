...
| TTS provider probe | ✅ TASK-TTS-004D DONE - CHARACTER VOICE FEASIBILITY RESEARCH COMPLETE / NO MODEL INSTALLED；GPT-SoVITS / Style-Bert-VITS2 long-term research candidates；edge-tts temporary/debug/fallback only；runtime disabled/mock-only |
