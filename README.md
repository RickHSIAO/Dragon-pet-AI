...
| TTS provider probe | ✅ TASK-TTS-004D2 IMPLEMENTED - CHARACTER VOICE ENV CHECK READY / NO INSTALL PERFORMED；GPT-SoVITS / Style-Bert-VITS2 environment evidence before install；runtime disabled/mock-only |
