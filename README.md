...
| [docs/TTS_ARCHITECTURE.md](docs/TTS_ARCHITECTURE.md) | TASK-TTS-001/TASK-TTS-002 provider-neutral TTS architecture：text normalization、disabled queue diagnostics、mock provider skeleton、Conversation Mode and Pet Window integration、diagnostics、phased plan |
| [docs/TTS_PROVIDER_RESEARCH.md](docs/TTS_PROVIDER_RESEARCH.md) | TASK-TTS-001/TASK-TTS-002 provider research：local/offline candidates、implemented mock provider boundary、evaluation criteria、voice data rules、future singing boundary |
...
| `docs/TTS_ARCHITECTURE.md` | TASK-TTS-001/TASK-TTS-002 provider-neutral local TTS architecture, mock provider skeleton, disabled queue diagnostics, text normalization, Conversation Mode, Pet speaking state, and phased implementation plan |
| `docs/TTS_PROVIDER_RESEARCH.md` | TASK-TTS-001/TASK-TTS-002 local TTS provider research boundaries, candidate categories, implemented mock provider non-quality boundary, evaluation criteria, voice data rules, and future provider path |
