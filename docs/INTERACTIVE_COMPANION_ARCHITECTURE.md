...
- TASK-STT-006B DONE - WINDOWS SCORING REPORT SMOKE PASS / DETERMINISTIC SCORING READY (2026-06-12):
  ...
  under `outputs/stt_model_scoring/YYYYMMDD/`. The completed flow stage is
  backend evaluation report -> deterministic scoring report -> future
  AI/Christina explanation. Profiles are
