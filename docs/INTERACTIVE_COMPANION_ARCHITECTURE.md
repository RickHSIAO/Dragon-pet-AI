...
- TASK-STT-007 IMPLEMENTED - AUTOMATED ADVISOR RUNNER SMOKE PASS / NEEDS WINDOWS END-TO-END RUNNER SMOKE (2026-06-12):
  ...
  flags. Runtime model selection remains manual through the existing
