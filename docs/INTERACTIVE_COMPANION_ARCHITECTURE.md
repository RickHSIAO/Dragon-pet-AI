...
- TASK-CONV-003 IMPLEMENTED - CONVERSATION MODE QUEUE BACKPRESSURE ARTIFACTS (2026-06-11):
  ...
  `audio=usable_audio`, and `dropStage=at_queue`; TASK-CONV-004 handles that
  capacity policy.
- TASK-CONV-004 IMPLEMENTED - CONVERSATION MODE QUEUE CAPACITY / BACKPRESSURE POLICY (2026-06-11):
  ...
  Renderer queue policy smoke PASS; Windows fast 4-turn actual-audio smoke
  remains required before DONE.
