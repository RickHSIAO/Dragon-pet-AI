...
| TASK-PERSONA-002 | Christina general tone sanitizer | Adds positive non-debug prompt guidance for proud, teasing, witty, protective replies without contempt, hostile unclear-input dismissal, comparative devaluation, threat/intimidation phrasing, waste-time hostility, or refusal/abandoning phrasing for companion/testing requests. Keeps TASK-PERSONA-001 debug repair first, then applies narrow general repair for known harsh fragments, repeated humiliation, unclear-input hostility, likely garbled-STT cases, comparative devaluation, threats, waste-time hostility, and companion/testing refusal fragments. Safe tsundere lines pass through. No `/chat` schema, mood schema, STT default, Owner Voice hard gate, renderer IPC, provider runtime, or runtime model change. IMPLEMENTED - third prompt/repair smoke PASS; needs Windows general tone re-smoke. |
...
refusal fragments. This does not change `/chat` response shape, mood schema,
renderer IPC, STT default, Owner Voice hard-gate behavior, provider runtime, or
