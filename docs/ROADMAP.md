...
**Next planned task:** TASK-199 — (Suggested: unread-badge / notification dot on Full App window title when Pet replies while the window is not focused; or keyboard shortcuts for search / clear search)
