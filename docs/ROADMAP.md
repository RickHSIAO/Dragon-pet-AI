...
**Next planned task:** TASK-201 — (Suggested: next UX polish; e.g. smooth scroll-to-bottom on new message, message timestamps hover tooltip, or Pet Window unread dot)
