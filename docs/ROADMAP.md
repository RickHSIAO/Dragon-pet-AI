...
**Next planned task:** TASK-202 — (Suggested: Chat UX polish — message timestamps visible on hover, smooth auto-scroll-to-bottom on new message, or Pet Window unread dot badge)
