...
- Define TASK-158 for the next planned feature or hardening pass. Pet Mode runtime, bubble cleanliness, expression mapping, Ollama JSON-output resilience, thinking state mirroring, and manual smoke runbook are all stable.
