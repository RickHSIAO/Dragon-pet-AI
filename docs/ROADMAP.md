...
- TASK-154 Windows manual smoke. Verify Full App `/chat` prompts can produce varied moods and visibly drive existing Christina expressions through the TASK-153 mapping while Pet Bubble speech remains clean.
